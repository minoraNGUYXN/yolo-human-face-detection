...
from .config import PERSON_MODEL_PATH, FACE_MODEL_PATH, EMOTION_MODEL_PATH, ACTION_MODEL_PATH
...
def load_models():
    ...
    return person_model, face_model, emotion_interpreter, action_interpreter
